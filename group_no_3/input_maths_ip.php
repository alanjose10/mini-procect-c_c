...
<html lang="en">
    ...
    <body>
       <div class="navbar-fixed">
        ...
        <br>
        <div>
            <span class="center-align"><h5 class="flow-text light">PLEASE ENTER 12TH BOARD MARKS (MATHS-IP):</h5></span>
        </div>
        <div class="row">
            <form class="col s12" method="post" action="<?php echo "$_SERVER[PHP_SELF]"; ?>">
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <label for="maths">Informatics Practices</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s6">
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql = "INSERT INTO maths_ip(user_id, ip, physics, chemistry, english, maths, sec_lang_name, second_lang) VALUES ('$row[user_id]', '$ip', '$physics', '$chemistry', '$english', '$maths', '$sec_lang_name', '$second_lang')";
