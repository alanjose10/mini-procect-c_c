...
<html lang="en">
    ...
    <body>
        ...
        <div class="row">
            <div class="col s10 offset-s1" >
                ...
                <thead class="blue lighten-1">
                    ...
                    switch($user_details["school_stream"])
                        {
                            case "bio_ip":        $sql2 = "SELECT  physics, chemistry, biology FROM bio_ip ORDER BY user_id DESC LIMIT 1";
                                break;
                            case "bio_language" : $sql2 = "SELECT biology, physics, chemistry FROM bio_lang ORDER BY user_id DESC LIMIT 1";
                                break;
                            case "bio_maths" :    $sql2 = "SELECT physics, chemistry, biology FROM bio_maths ORDER BY user_id DESC LIMIT 1";
                                break;
                            ...
                            case "commerce_maths" : echo "<br>Sorry, the selected college stream is not possible with the school stream you have taken.<br><br>";
                                                    die();
                                                    break;
                            case "computer_maths" : echo "<br>Sorry, the selected college stream is not possible with the school stream you have taken.<br><br>";
                                                    die();
                                                    break;
                            case "maths_ip" : echo "<br>Sorry, the selected college stream is not possible with the school stream you have taken.<br><br>";
                                                    die();
                                                    break;
                            case "maths_language" : echo "<br>Sorry, the selected college stream is not possible with the school stream you have taken.<br><br>";
                                                    die();
                                                    break;
                        }
                   ...
                   // print_r($user_marks);
                    ...
                    $mbbs_board = ($biology + $physics + $chemistry);
                    $total=$mbbs_board*0.4;
                    $lb = $total - 11;
                    $ub = $total + 11;
                    $sql_passion = "SELECT college_id, college_name FROM mbbs WHERE benchmark BETWEEN $lb AND $ub ORDER BY college_id ASC";
            ...
            <br><br><div class="row">
                <div class="col s4 offset-s4"><p>Course Name:   MBBS</p>
                </div>
            </div>
        </div>
