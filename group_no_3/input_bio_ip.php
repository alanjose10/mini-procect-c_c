...
<html lang="en">
    ...
    <body>
       <div class="navbar-fixed">
        ...
        <br>
        <div>
            <span class="center-align"><h5 class="flow-text light">PLEASE ENTER 12TH BOARD MARKS (BIO-IP):</h5></span>
        </div>
        <div class="row">
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql = "INSERT INTO bio_ip(user_id, ip, physics, chemistry, english, biology, sec_lang_name, second_lang) VALUES ('$row[user_id]', '$ip', '$physics', '$chemistry', '$english', '$biology', '$sec_lang_name', '$second_lang')";
