...
<html lang="en">
    ...
    <body>
       <div class="navbar-fixed">
        ...
        <br>
        <div>
            <span class="center-align"><h5 class="flow-text light">PLEASE ENTER 12TH BOARD MARKS (BIO-LANGUAGE):</h5></span>
        </div>
        <div class="row">
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql = "INSERT INTO bio_lang(user_id, biology, physics, chemistry, english, sec_lang_name, second_lang) VALUES ('$row[user_id]', '$biology', '$physics', '$chemistry', '$english', '$sec_lang_name', '$second_lang')";
