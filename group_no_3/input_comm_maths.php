...
<html lang="en">
    ...
    <body>
       <div class="navbar-fixed">
        ...
        <br>
        <div>
            <span class="center-align"><h5 class="flow-text light">PLEASE ENTER 12TH BOARD MARKS (COMMERCE-MATHS):</h5></span>
        </div>
        <div class="row">
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql = "INSERT INTO commerce_maths(user_id, maths, english, commerce, accounts, business, sec_lang_name, second_lang) VALUES ('$row[user_id]', '$maths', '$english', '$commerce', '$accounts', '$business', '$sec_lang_name', '$second_lang')";
