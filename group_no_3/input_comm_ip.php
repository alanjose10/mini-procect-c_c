...
<html lang="en">
    ...
    <body>
       <div class="navbar-fixed">
        ...
        <br>
        <div>
            <span class="center-align"><h5 class="flow-text light">PLEASE ENTER 12TH BOARD MARKS (COMMERCE-IP):</h5></span>
        </div>
        <div class="row">
            <form class="col s12" method="post" action="<?php echo "$_SERVER[PHP_SELF]"; ?>">
                ...
                <div class="row">
                    <div class="input-field col s6">
                        <input id="ip" name="ip" type="number" class="validate">
                        <label for="ip">Informatics Practices</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s6">
                        <input id="commerce" name="commerce" type="number" class="validate">
                        <label for="commerce">Commerce</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s6">
                        <input id="accounts" name="accounts" type="number" class="validate">
                        <label for="accounts">Accounts</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s6">
                        <input id="business" name="business" type="number" class="validate">
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql = "INSERT INTO commerce_ip(user_id, maths, ip, commerce, accounts, business, sec_lang_name, second_lang) VALUES ('$row[user_id]', '$maths', '$ip', '$commerce', '$accounts', '$business', '$sec_lang_name', '$second_lang')";
